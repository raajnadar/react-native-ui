import { Typography, Column } from '@rn-ui/components'
    ...
    <ScrollView contentContainerStyle={styles.content}>
      ...
      <Column gap="sm">
        ...
        <Typography variant="bodyLarge" style={styles.paragraph}>
          This is the first paragraph of the article. It uses the bodyLarge
          variant which is ideal for body text that needs to be easily readable
